...
class StoreController extends BaseAdminController
{
    ...
    protected function addUrlAction()
    {
        ...
        $checkUrl = $this->entityManager->getRepository('App:StoreUrl')->findOneBy(
            ['url' => $url]
        );
        ...
        if ($checkUrl) {
            ...
            $this->entityManager->persist($storeUrl);
    ...
    protected function deleteUrlAction()
    {
        ...
        $url = $this->entityManager->getRepository('App:StoreUrl')
            ->find($urlId);
