 ...
 */
final class Version20200409080135 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE instashop DROP description');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Instashop ADD description TEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE Instashop ALTER id DROP DEFAULT');
