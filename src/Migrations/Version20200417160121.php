...
final class Version20200417160121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE instashop_product (instashop_id INT NOT NULL, product_id INT NOT NULL, PRIMARY KEY(instashop_id, product_id))');
        ...
        $this->addSql('CREATE SEQUENCE instashop_translations_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE InstashopTranslations (id INT NOT NULL, translatable_id INT DEFAULT nextval(\'public.instashop_translations_id_seq\'::regclass), title VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, locale VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE instashop_translations_id_seq CASCADE');
