 ...
 */
final class Version20191112123040 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD lenses TEXT DEFAULT NULL');
        $this->addSql('COMMENT ON COLUMN product.lenses IS \'(DC2Type:json)\'');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Product DROP lenses');
    }
}
